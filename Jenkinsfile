...
Module componentsParent = new Module.Builder('main/parent')
        .withRelease()
        .withConsumer(componentsAll, [ new ParentPomUpdateCommand() ], true)
        .withConsumer(componentsConfig, [ new ParentPomUpdateCommand() ], true)
        .withConsumer(componentsContent, [ new ParentPomUpdateCommand() ], true)
        .withConsumer(componentsCore, [ new ParentPomUpdateCommand() ], true)
        .withConsumer(componentsExtCFBundle, [ new ParentPomUpdateCommand() ], true)
        .withConsumer(componentsExtCFContent, [ new ParentPomUpdateCommand() ], true)
        .withConsumer(componentsExtension, [ new ParentPomUpdateCommand() ], true)
        .withConsumer(componentsItUi, [ new ParentPomUpdateCommand() ], true)
        .withConsumer(componentsJUnitCore, [ new ParentPomUpdateCommand() ], true)
        .withBuild()
        .build()
