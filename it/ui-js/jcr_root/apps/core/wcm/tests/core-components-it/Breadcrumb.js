...
;(function(h,$){
    window.CQ.CoreComponentsIT.TestBreadcrumb = function (h, $) {
        return new h.TestCase("Navigate to Edit page")
            .navigateTo("/editor.html/content/core-components/core-components-page.html")
            .asserts.location("/editor.html/content/core-components/core-components-page.html", true);
    }
