...
public class ParagraphModeRenderCondition extends SlingSafeMethodsServlet {
    ...
    public static final String RESOURCE_TYPE = "core/wcm/extension/sandbox/components/contentfragment/v1/renderconditions/paragraphmode";

    /**
     * Name of the resource property containing the path to a
     * {@code /apps/core/wcm/extension/sandbox/components/contentfragment} component to use for this render condition.
