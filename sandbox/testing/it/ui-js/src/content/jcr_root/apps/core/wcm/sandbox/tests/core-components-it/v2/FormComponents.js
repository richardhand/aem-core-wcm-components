...
;(function(h, $){
    ...
    var tcExecuteBeforeTest = new TestCase("Setup Before Test")
        ...
        .execFct(function (opts, done){
            c.addComponent(c.rtFormOptions_v2, h.param("containerPath")(opts) + "/","optionPath",done)
        })
     ...
     * The main test suite.
     */
    new h.TestSuite("Core Components - Form Submit v2",{path:"/apps/core/wcm/sandbox/tests/core-components-it/v2/FormComponents.js",
