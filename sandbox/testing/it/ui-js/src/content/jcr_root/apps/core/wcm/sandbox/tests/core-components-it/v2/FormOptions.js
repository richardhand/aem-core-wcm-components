...
;(function(h, $){
    ...
    var tcExecuteBeforeTest = new TestCase("Setup Before Test")
        ...
        .execFct(function (opts, done){
            c.addComponent(c.rtFormOptions_v2, h.param("testPagePath")(opts)+c.relParentCompPath,"optionPath",done)
        })
    ...
    var setHelpMessage = new h.TestCase("Set Help Message",{
        ...
        .asserts.isTrue(function() {
             return h.find(".cmp-form-options__help-block","#ContentFrame").text().trim() == helpMessage;
        })
    ;
    ...
    var setCheckbox = new h.TestCase("Set checkbox type",{
        ...
        .asserts.isTrue(function() {
            return h.find(".cmp-form-options__form-group-checkbox","#ContentFrame").size() == 1;
        })
    ;
    ...
    var setRadioButton = new h.TestCase("Set radio button type",{
        ...
        .asserts.isTrue(function() {
            return h.find(".cmp-form-options__form-group-radio","#ContentFrame").size() == 1;
        })
    ;
    ...
    var setDropDown = new h.TestCase("Set drop-down type",{
        ...
        .asserts.isTrue(function() {
            return h.find(".cmp-form-options__form-group-drop-down","#ContentFrame").size() == 1;
        })
    ;
    ...
    var setMultiSelectDropDown = new h.TestCase("Set multi-select drop-down type",{
        ...
        .asserts.isTrue(function() {
            return h.find(".cmp-form-options__form-group-multi-drop-down","#ContentFrame").size() == 1;
        })
    ;
    ...
    new h.TestSuite('Core Components - Form Options v2', {path: '/apps/core/wcm/sandbox/tests/core-components-it/v2/FormOptions.js',
