...
;(function (h, $) {
    ...
    var tcExecuteBeforeTest = new TestCase("Setup Before Test")
        ...
        .execFct(function (opts, done) {
            c.createPage(c.template, c.rootPage, 'page_' + Date.now(), "parentPath", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })

        // add page 1
        .execFct(function (opts, done) {
            c.createPage(c.template, h.param("parentPath")(opts), 'page_1', "page1Path", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })
        // set tag on the page
        .execFct(function (opts, done) {
            var data = {};
        ...
        // add page 2
        .execFct(function (opts, done) {
            c.createPage(c.template, h.param("parentPath")(opts), 'page_2', "page2Path", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })
        // add a text component
        .execFct(function (opts, done) {
            c.addComponent(c.rtText_v2, h.param("page2Path")(opts) + c.relParentCompPath, "text1Path", done)
        })
        ...
        .execFct(function (opts, done) {
            c.createPage(c.template, h.param("page2Path")(opts), 'sub_2_1', "page21Path", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })
        // create second sub page for page 2
        .execFct(function (opts, done) {
            c.createPage(c.template, h.param("page2Path")(opts), 'sub_2_2', "page22Path", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })
        // add page 3
        .execFct(function (opts, done) {
            c.createPage(c.template, h.param("parentPath")(opts), 'page_3', "page3Path", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })
        ...
        // create page 4
        .execFct(function (opts, done) {
            c.createPage(c.template, h.param("parentPath")(opts), 'page_4', "page4Path", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })
        // create a sub page for page 4
        .execFct(function (opts, done) {
            c.createPage(c.template, h.param("page4Path")(opts), 'sub_4_1', "page41Path", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })
        // add a text component
        .execFct(function (opts, done) {
            c.addComponent(c.rtText_v2, h.param("page41Path")(opts) + c.relParentCompPath, "text2Path", done)
        })
        // set some text value
        .execFct(function (opts, done) {
            var data = {};
        ...
        // create page 5
        .execFct(function (opts, done) {
            c.createPage(c.template, h.param("parentPath")(opts), 'page_5', "page5Path", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })
        // set tag on the page
        .execFct(function (opts, done) {
            var data = {};
        ...
        .execFct(function (opts, done) {
            c.addComponent(c.rtList_v2, h.param("testPagePath")(opts) + c.relParentCompPath, "cmpPath", done)
        })
     ...
     */
    var createListDirectChildren = new h.TestCase('List of direct Children', {
        execBefore: tcExecuteBeforeTest,
        execAfter: tcExecuteAfterTest})

        // create 3 direct sub pages
        .execFct(function (opts, done) {
            c.createPage(c.template, h.param("testPagePath")(opts), 'direct_1', "subpage1Path", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })
        .execFct(function (opts, done) {
            c.createPage(c.template, h.param("testPagePath")(opts), 'direct_2', "subpage2Path", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })
        .execFct(function (opts, done) {
            c.createPage(c.template, h.param("testPagePath")(opts), 'direct_3', "subpage3Path", done, 'core/wcm/sandbox/tests/components/test-page-v2')
        })
     ...
     */
    var createListChildren = new h.TestCase('List of Children', {
        execBefore: tcExecuteBeforeTest,
        execAfter: tcExecuteAfterTest})
     ...
     */
    var listSubChildren = new h.TestCase('List with Subchildren', {
        execBefore: tcExecuteBeforeTest,
        execAfter: tcExecuteAfterTest})
     ...
     */
    var createFixedList = new h.TestCase('Create a fixed List', {
        execBefore: tcExecuteBeforeTest,
        execAfter: tcExecuteAfterTest})
     ...
     */
    var createListBySearch = new h.TestCase('Create List using Search', {
        execBefore: tcExecuteBeforeTest,
        execAfter: tcExecuteAfterTest})
     ...
     */
    var createListAnyTagsMatching = new h.TestCase('List with any Tags matching', {
        execBefore: tcExecuteBeforeTest,
        execAfter: tcExecuteAfterTest})
     ...
     */
    var createListAllTagsMatching = new h.TestCase('List with all Tags matching', {
        execBefore: tcExecuteBeforeTest,
        execAfter: tcExecuteAfterTest})
     ...
     */
    var orderByTitle = new h.TestCase('Order List by Title', {
        execBefore: tcExecuteBeforeTest,
        execAfter: tcExecuteAfterTest})
     ...
     */
    var changeOrderingTitle = new h.TestCase('Change Sort Order for Title', {
        execBefore: tcExecuteBeforeTest,
        execAfter: tcExecuteAfterTest})
     ...
     */
    var orderByLastModifiedDate = new h.TestCase('Order by Last Modified Date', {
        execBefore: tcExecuteBeforeTest,
        execAfter: tcExecuteAfterTest})
     ...
     * Test: order list by last modified date
     */
    var changeOrderingDate = new h.TestCase('Change Sort Order for Date', {
        execBefore: tcExecuteBeforeTest,
        execAfter: tcExecuteAfterTest})
     ...
     */
    new h.TestSuite('Core Components - List v2', {path: '/apps/core/wcm/sandbox/tests/core-components-it/v2/List.js',
        execBefore:c.tcExecuteBeforeTestSuite,
        execInNewWindow : false})

        .addTestCase(createListDirectChildren)
        .addTestCase(createListChildren)
        .addTestCase(listSubChildren)
        .addTestCase(createFixedList)
        .addTestCase(createListBySearch)
        .addTestCase(createListAnyTagsMatching)
        .addTestCase(createListAllTagsMatching)
        .addTestCase(orderByTitle)
        .addTestCase(changeOrderingTitle)
