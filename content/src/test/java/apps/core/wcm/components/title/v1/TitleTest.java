...
public class TitleTest extends WCMUsePojoBaseTest<Title> {
    ...
    static {
        TEST_CONTENT_ROOT = "/content/title";
        TEST_BASE = "/title";
    }

    public static final String TITLE_RESOURCE_JCR_TITLE = TEST_CONTENT_ROOT + "/jcr:content/par/title-jcr-title";
    public static final String TITLE_RESOURCE_JCR_TITLE_TYPE = TEST_CONTENT_ROOT + "/jcr:content/par/title-jcr-title-type";
    public static final String TITLE_NOPROPS = TEST_CONTENT_ROOT + "/jcr:content/par/title-noprops";
    public static final String TITLE_WRONGTYPE = TEST_CONTENT_ROOT + "/jcr:content/par/title-wrongtype";
