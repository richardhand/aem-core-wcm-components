...
public interface Navigation {
    ...
    /**
     * Name of the resource / configuration policy property that defines if the resulted navigation tree should skip including the site
     * root, but include its children. The property should provide a Boolean value ({@code true} if the site root should be omitted,
