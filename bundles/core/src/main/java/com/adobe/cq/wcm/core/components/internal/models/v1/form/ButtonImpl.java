...
@Model(adaptables = {SlingHttpServletRequest.class, Resource.class},
       ...
       resourceType = {ButtonImpl.RESOURCE_TYPE_V1, ButtonImpl.RESOURCE_TYPE_V2})
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME, extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class ButtonImpl extends AbstractFieldImpl implements Button, ComponentExporter {

    public static final String RESOURCE_TYPE_V1 = FormConstants.RT_CORE_FORM_BUTTON + "/v1/button";
    public static final String RESOURCE_TYPE_V2 = FormConstants.RT_CORE_FORM_BUTTON_SANDBOX + "/v2/button";
