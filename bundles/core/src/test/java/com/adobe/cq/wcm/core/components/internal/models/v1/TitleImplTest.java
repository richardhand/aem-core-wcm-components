...
public class TitleImplTest {
    ...
    private static final String TITLE_RESOURCE_JCR_TITLE_SANDBOX = TEST_PAGE + "/jcr:content/par/title-jcr-title-sandbox";
    ...
    public void testV2JSONExport() {
        Title title = getTitleUnderTest(TITLE_RESOURCE_JCR_TITLE_SANDBOX);
        Utils.testJSONExport(title, Utils.getTestExporterJSONPath(TEST_BASE, TITLE_RESOURCE_JCR_TITLE_SANDBOX));
    }
