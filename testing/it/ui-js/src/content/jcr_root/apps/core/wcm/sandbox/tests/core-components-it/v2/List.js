...
;(function (h, $) {
    ...
    var listV1 = window.CQ.CoreComponentsIT.v1.List;

    /**
     * v2 specifics
     */
    var tcExecuteBeforeTest = listV1.tcExecuteBeforeTest(c.rtList_v2, c.rtText_v2, "core/wcm/sandbox/tests/components/test-page-v2");
