...
window.CQ.CoreComponentsIT.v1.List = window.CQ.CoreComponentsIT.v1.List || {}
...
;(function (h, $) {
    ...
    var list = window.CQ.CoreComponentsIT.v1.List;
     ...
     */
    list.tcListSubChildren = function () {
     ...
     */
    list.tcCreateListAllTagsMatching = function () {
