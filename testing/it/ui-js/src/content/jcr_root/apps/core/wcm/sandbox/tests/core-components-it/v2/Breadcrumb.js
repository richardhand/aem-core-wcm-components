...
;(function(h, $){
    ...
    var breadcrumbV1 = window.CQ.CoreComponentsIT.v1.Breadcrumb;
    ...
    var tcExecuteBeforeTest = breadcrumbV1.tcExecuteAfterTest(c.rtBreadcrumb_v2, 'core/wcm/sandbox/tests/components/test-page-v2');
