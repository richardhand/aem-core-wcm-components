...
;(function (h, $) {
    ...
    window.CQ.CoreComponentsIT.v1.LanguageNavigation = window.CQ.CoreComponentsIT.v1.LanguageNavigation || {};

    var c                  = window.CQ.CoreComponentsIT.commons;
    var languageNavigation = window.CQ.CoreComponentsIT.v1.LanguageNavigation;
    ...
    languageNavigation.testChangeStructureDepth = function (tcExecuteBeforeTest, tcExecuteAfterTest) {
        return new TestCase('Change Structure Depth', {
            execBefore: tcExecuteBeforeTest,
            execAfter : tcExecuteAfterTest
        })
            .execTestCase(c.tcOpenConfigureDialog('cmpPath'))
    ...
    languageNavigation.testSetStructureDepthZero = function (tcExecuteBeforeTest, tcExecuteAfterTest) {
        return new TestCase('Set Structure Depth zero', {
            execBefore: tcExecuteBeforeTest,
            execAfter : tcExecuteAfterTest
        })
            .execTestCase(c.tcOpenConfigureDialog('cmpPath'))
