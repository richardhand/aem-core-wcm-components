...
window.CQ.CoreComponentsIT.v1.FormText = window.CQ.CoreComponentsIT.v1.FormText || {}
...
;(function (h, $) {
    ...
    var formTextV1 = window.CQ.CoreComponentsIT.v1.FormText;
    ...
    var tcExecuteBeforeTest = formTextV1.tcExecuteBeforeTest(c.rtFormText_v2, "core/wcm/sandbox/tests/components/test-page-v2");
