...
;(function(h, $) {
    ...
    c.policyPath = "/conf/core-components/settings/wcm/policies/core/wcm/sandbox/components";
    // the policy assignment path
    c.policyAssignmentPath = "/conf/core-components/settings/wcm/templates/core-components/policies/jcr:content/root/responsivegrid/core/wcm/sandbox/components";
     ...
     * @param [testPageRT='core/wcm/sandbox/tests/components/test-page-v1'] the resource type of the test page
     */
    c.createPage = function (templatePath, parentPath, pageName, dynParName, done, testPageRT) {
        ...
        jQuery.ajax({
            ...
            data: {
                ...
                "./jcr:title": pageName,
                "pageName": pageName,
                "./sling:resourceType": testPageRT || 'core/wcm/sandbox/tests/components/test-page-v1'
            }
        })
