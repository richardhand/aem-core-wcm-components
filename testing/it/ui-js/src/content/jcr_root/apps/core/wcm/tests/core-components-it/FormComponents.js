 ...
 */
window.CQ.CoreComponentsIT.v1.FormComponents = window.CQ.CoreComponentsIT.v1.FormComponents || {}
...
;(function(h, $) {
    ...
    var formComponents = window.CQ.CoreComponentsIT.v1.FormComponents;
