...
;(function(h, $){
    ...
    var formContainerV1 = window.CQ.CoreComponentsIT.v1.FormContainer;

    /**
     * v2 specifics
     */
    var tcExecuteBeforeTest = formContainerV1.tcExecuteBeforeTest(c.rtFormContainer_v2, c.rtFormText_v2, c.rtFormButton_v2, "core/wcm/sandbox/tests/components/test-page-v2");
    var tcExecuteAfterTest = formContainerV1.tcExecuteAfterTest();

    /**
     * The main test suite.
     */
    new h.TestSuite("Core Components - Form Container v2",{path:"/apps/core/wcm/sandbox/test-suites/core-components-it/v2/FormContainer.js",
