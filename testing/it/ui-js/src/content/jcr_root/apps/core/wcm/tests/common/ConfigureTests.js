...
;(function(h) {
     ...
     */
    window.CQ.CoreComponentsIT.OpenConfigureWindow = function (h, $, selector) {
        return new h.TestCase("Open the Configure window")
            ...
            .click(".cq-editable-action[title='Configure']")
            .assert.visible(".cq-dialog.foundation-form.foundation-layout-form")
        ;
    }
    ...
    window.CQ.CoreComponentsIT.OpenFullSreen = function (h,$) {
        return new h.TestCase("Open the full screen")
            ...
            .assert.visible(".cq-dialog-header", true)
            .click(".coral-Icon.coral-Icon--fullScreen")
        ;
    }
    ...
    window.CQ.CoreComponentsIT.FillNavigationLevel = function (h,$,selector, inputValue, itemNo, activeItemNo) {
        ...
        //Open the Configure window
            ...
            .assert.isTrue(function() {return window.CQ.CoreComponentsIT.checkNumberOfItemsFromIFrame(h,"#ContentFrame",".breadcrumb-item", itemNo)})
            .assert.isTrue(function() {return window.CQ.CoreComponentsIT.checkNumberOfItemsFromIFrame(h,"#ContentFrame",".breadcrumb-item--activ",activeItemNo)})
    ...
    window.CQ.CoreComponentsIT.CheckNavigationLevel = function (h,$, selector, inputValue, itemNo, activeItemNo){
        return new h.TestCase("Check the Navigtion Level")
            ...
            .click(selector)
            .assert.isTrue(function(){return window.CQ.CoreComponentsIT.checkInputValue(h,".coral-Textfield.coral-InputGroup-input[id^='coral-id']",inputValue)})
            ...
            .assert.isTrue(function() {return window.CQ.CoreComponentsIT.checkNumberOfItemsFromIFrame(h,"iframe#ContentFrame",".breadcrumb-item", itemNo)})
            .assert.isTrue(function() {return window.CQ.CoreComponentsIT.checkNumberOfItemsFromIFrame(h,"iframe#ContentFrame",".breadcrumb-item--active", activeItemNo)})
